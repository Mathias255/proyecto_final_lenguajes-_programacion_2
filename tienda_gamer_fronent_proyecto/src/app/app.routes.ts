...
import { MisResenasComponent } from './pages/mis-resenas/mis-resenas';
...
import { AdminMetodosPagoComponent } from './pages/admin-metodos-pago/admin-metodos-pago';
...
export const routes: Routes = [
  ...
  { path: 'admin/proveedores', component: AdminProveedoresComponent, canActivate: [adminGuard] },
  { path: 'admin/metodos-pago', component: AdminMetodosPagoComponent, canActivate: [adminGuard] },
